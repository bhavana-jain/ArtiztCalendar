 ...
 signIn = async() => {
   try {
    const result = await Expo.Google.logInAsync({
      androidClientId:"201519723758-64mpvs64lb63qa13910402ipvgccuec4.apps.googleusercontent.com",
  ...
  render() {
   ...
   <ImageBackground source={require('../assets/images/SplashScreen_ArtWork.png')}
        ...
        <View style={styles.layoutSpacer}>     
        <TouchableOpacity activeOpacity={0.9} style={{display: 'flex', flexDirection:'row', borderColor: '#f83333', borderWidth: 1, borderRadius: 2}} onPress={() => this.signIn()}>
